          ...
          <ShowNotificationContext.Provider value={showNotificationValue}>
            ...
            <div className="mainContainer">
              ...
              <div className='text-center'>
                ...
                {/* {!currentAccount && (
                  <button 
                    className="waveButton inline-flex items-center px-4 py-2 mr-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-indigo-600 bg-white hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                    onClick={fakeConnectWallet}
                  >
                    FAKE Connect Wallet
                  </button>
                )} */}
